...
1차 개발 환경에서는 1차 팀장 노트북의 Oracle DB에 내부 네트워크로 접속했고, 개인 테스트 시에는 각자 PC의 localhost Oracle DB로 접속 정보를 변경해 사용했습니다. 저장소의 접속값은 당시 교육·테스트 환경의 정보이며 현재 운영 환경에서 사용하는 계정 정보가 아닙니다.
